...
void __init exynos4_smdk4270_charger_init(void)
{
	...
	sec_battery_pdata.temp_high_threshold_normal = 530;
	sec_battery_pdata.temp_high_recovery_normal = 480;
	sec_battery_pdata.temp_low_threshold_normal = -40;
	sec_battery_pdata.temp_low_recovery_normal = 20;
	sec_battery_pdata.temp_high_threshold_lpm = 520;
	sec_battery_pdata.temp_high_recovery_lpm = 490;
